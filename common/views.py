...
class BlogDetailView(DetailView):
    queryset = models.Blog.objects.all().annotate(count=Count("comments")).prefetch_related("categories")
    slug_field = "slug"
    ...
    def get_context_data(self, **kwargs):
        ...
        context["categories"] = models.BlogCategory.objects.all().prefetch_related("categories")
